...
/**
 * Orders taxon nodes by their rank first, then scientific name.
 */
public class TaxonOrder implements Comparator<Node> {

  @Override
  public int compare(Node n1, Node n2) {
    int r1 = (int) n1.getProperty(TaxonProperties.RANK, 9999);
    int r2 = (int) n2.getProperty(TaxonProperties.RANK, 9999);
