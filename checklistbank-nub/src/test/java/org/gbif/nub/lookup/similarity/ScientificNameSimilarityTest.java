...
//    assertEquals(80d, sns.getSimilarity("abcdefg", "acdefg"), 0.01d);
    ...
    assertEquals(100d, sns.getSimilarity("äöüæøåœđł", "aeoeueaeoeaaoedl"), 0.01d);
    ...
    assertEquals(95d, sns.getSimilarity("Linaria pedunculata", "Linariya pedonculata"), 0.01d);
