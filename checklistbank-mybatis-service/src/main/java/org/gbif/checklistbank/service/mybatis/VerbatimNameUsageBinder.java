 ...
 */
public class VerbatimNameUsageBinder {

  private static final Logger LOG = LoggerFactory.getLogger(VerbatimNameUsageBinder.class);
  private final ObjectMapper mapper;

  @JsonIgnoreType
  public static class IgnoreMixin {}

  public VerbatimNameUsageBinder() {
